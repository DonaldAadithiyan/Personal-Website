...
function PageView({ id, onBack, onNav }) {
  ...
  // pull the leading index out of the kicker (e.g. "02 — Projects") for the ghost number
  const ghost = (pg.kicker && (pg.kicker.match(/\d+/) || [])[0]) || '';
      ...
      <div className="pg-scroll">
        <div className="pg-inner">
          ...
          <div className="pg-hero">
            ...
            {ghost ? <div className="pg-ghost" aria-hidden="true">{ghost}</div> : null}
